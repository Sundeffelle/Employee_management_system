...
<div class="container-fluid">
    ...
    <div class="alert alert-success text-center" role="alert">
        <!-- If needed, you can place a link back to a main page or index here -->
        <!-- <a href="index.php" class="alert-link">Home Page</a> -->
    </div>
    ...
    <div class="row justify-content-center">
        <div class="col-8">
            <div class="card bg-light mb-3">
                ...
                <div class="card-body">
                    <!-- Display errors or success messages if needed:
                    ...
                    <form method="POST" action="../app/register.php" enctype="multipart/form-data">
                        <!-- Grouped Fields -->
                        <div class="input-group mb-3">
                            <input type="text" name="full_name" id="full_name" class="form-control" placeholder="FullName" required>
